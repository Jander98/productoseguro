...
using webapiProcductoSecurity.Models;
using webapiProcductoSecurity.Providers;
using webapiProcductoSecurity.Results;

namespace webapiProcductoSecurity.Controllers
{
    [Authorize]
